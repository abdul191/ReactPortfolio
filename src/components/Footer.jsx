      ...
      <div className="footerLinkContainer">
        ...
        <div className="footerSocialIcon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100051604160326&mibextid=ZbWKwL"
            ...
            <li>
              <a
                href="https://www.instagram.com/itz_abdulrehman_?igsh=YW0yNGN3ZXJpOGto"
                className="navbarContent"
                target="_blank"
            ...
            <li>
              <a
                href="https://x.com/Abdul15721?t=y9DIvxDowWv6Lhgq9TeYXQ&s=09"
                className="navbarContent"
                target="_blank"
                rel="noreferrer">
                <svg
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/abdul-rehman-08bb78200?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="navbarContent"
                target="_blank"
                rel="noreferrer">
                <svg
